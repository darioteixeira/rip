...
(* OASIS_START *)
(* DO NOT EDIT (digest: 75ac9097ad0b841c6a2c661b84d65c13) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build auxiliary library \"Rip_lwt\"";
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Rip";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\174Wa\209\192)\177\026\202[\187\024\222\217\196V";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
